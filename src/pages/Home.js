...
const Home=()=>{
    ...
    return <Fragment>
           <div className="bg-[#232425] w-full h-screen text-[#a9a9b3]" onClick={handlePageRoute}>
                <div className="flex flex-col h-screen items-center justify-center text-center">
                    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                        ...
                        <div className="flex flex-wrap justify-center">
                            ...
                            <a href="https://www.facebook.com/iammhhabib/" className="text-blue-700 border border-[#2D9596] hover:bg-[#2D9596]  hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center me-5 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:focus:ring-blue-800 dark:hover:bg-blue-500">
                            ...
                            <a href="https://github.com/mhhabib/" className="text-blue-700 border border-[#2D9596] hover:bg-[#2D9596]  hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center me-5 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:focus:ring-blue-800 dark:hover:bg-blue-500">
                            <svg className="w-4 h-4 text-gray-100 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="footer">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
                        ...
                        <a href="/me" className="inline-flex mb-4 px-3 text-sm font-normal leading-none text-blue-700 selection:bg-gray-600 selection:text-pink-400">Next
